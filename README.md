...
> [!TIP]
> **Seamless In-App Updates:** Once installed, FocusTimer checks for new versions once a day and installs them in seconds with a single click. You can turn the check off under **Settings › System & Updates**.
